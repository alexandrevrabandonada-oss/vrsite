...
$entries = @(
  @{src='payload\src\lib\ig-data.ts'; dst='src\lib\ig-data.ts'},
...
git add -A
git commit -m 'refactor(ig): camada unica de dados (route + page usam a mesma fonte)' | Out-Null
