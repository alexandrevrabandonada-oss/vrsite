...
$backupDir = 'backup-appfiles-' + $stamp
New-Item -ItemType Directory -Force -Path $backupDir | Out-Null

$entries = @(
  @{src='payload\src\app\layout.tsx'; dst='src\app\layout.tsx'},
...
git add -A
git commit -m 'fix(app): corrigir layout.tsx e page.tsx (encoding/sintaxe)' | Out-Null
