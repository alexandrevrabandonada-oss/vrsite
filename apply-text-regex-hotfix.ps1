...
if ($changed -eq 0) { Warn 'Nenhuma ocorrencia de \\p{Diacritic} encontrada em src/**/*.ts*' }

Say '==> Commitando e enviando'
git add -A
git commit -m 'fix(text): substituir \\p{Diacritic} por [\\u0300-\\u036f] para compatibilidade' | Out-Null
