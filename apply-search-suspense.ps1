...
$entries = @(
  ...
  @{src='payload\src\app\search\search-client.tsx'; dst='src\app\search\search-client.tsx'}
)
...
git add -A
git commit -m 'fix(search): envolver useSearchParams em <Suspense> e forcar dynamic' | Out-Null
