...
$entries = @(
  ...
  @{src='payload\src\app\instagram\page.tsx'; dst='src\app\instagram\page.tsx'},
  @{src='payload\middleware.ts'; dst='middleware.ts'}
)

$stamp = Get-Date -Format 'yyyyMMdd-HHmmss'
$backup = "backup-safe-links-$stamp"
...
git add -A
git commit -m 'fix(nav): links robustos no feed + /instagram index + rewrites de rotas antigas' | Out-Null
